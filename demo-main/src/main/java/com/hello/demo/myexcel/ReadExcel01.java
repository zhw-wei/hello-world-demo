...
//        analysis();
        ...
        Map<String, List<String>> contractMap = (Map) JSON.parseObject(str);
...
//        printInOrgan(contractMap);
        ...
        contractMap.forEach((organName, codeList) -> {
            ...
            //输出update sql语句
            System.out.println(String.format(temp, organName, organId, codeStr));
    ...
    private static void analysis() throws Exception {
        ...
        Workbook workbook = WorkbookFactory.create(new File("c:/Users/user/Desktop/海纳万商历史合同——项目机构.xls"));
