...
@NoArgsConstructor
@Data
public class StoreGoodsRelDetailPageResDto {

    @ExcelInfo(headerName = "分类名称")
    private String goodsTypeName = "aaa";

    @ExcelInfo(headerName = "物料编码", parentVal = "TEST01", parentWidth = 3, sParentVal = "P_TEST_01", sParentWidth = 6)
    private String goodsInstCode = "bbb";
